...
[_QWERTY] = LAYOUT( \
    ...
    KC_BSPC,  KC_A,   KC_S,   KC_D,   KC_F,   KC_G,LGUI(LSFT(KC_4)),    LGUI(LSFT(LALT(KC_C))),  KC_H,   KC_J,   KC_K,   KC_L,  KC_SCLN,   KC_MINS,
	...
	[_FLASH] = LAYOUT( \
		KC_TRNS, LGUI(KC_EQL), LGUI(KC_MINS), KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, RESET,
		KC_TRNS, KC_N, KC_V, KC_F8, LSFT(LALT(KC_F12)), KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
		KC_TRNS, LGUI(KC_Z), LGUI(KC_Y), LGUI(KC_C), LGUI(KC_V), KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
    ...
    [_ART] = LAYOUT( \
  		KC_TRNS, LGUI(KC_PPLS), LGUI(KC_PMNS), LGUI(KC_0), KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
  		KC_P, KC_B, KC_H, LGUI(LSFT(KC_H)), KC_D, KC_C, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
  		KC_TRNS, LGUI(KC_Z), LGUI(LSFT(KC_Z)), LSFT(KC_X), LGUI(LSFT(KC_N)), LGUI(LALT(KC_G)), KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
